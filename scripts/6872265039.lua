...
if shared.HorizonSavedSessionInfo~= nil then 
    local api = shared.HorizonSavedSessionInfo
    local st = api.startTime
    local stringtp = "shared.HorizonSavedSessionInfo = {startTime ="..tostring(st)..", kills = "..api.kills..", wins = "..api.wins..", lagbacks = "..api.lagbacks.."}"
